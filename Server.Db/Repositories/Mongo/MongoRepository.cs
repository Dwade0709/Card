...
namespace Server.Db.Repositories.Mongo
{
    public class MongoRepository<T> : IMongoRepository<T> where T : MongoEntity
    {
        ...
        {
            Collection = MongoDatabase<T>.GetCollection(config);
        }
        ...
        {
            Collection = MongoDatabase<T>.GetCollectionFromConnectionString(connectionString);
        }
        ...
        {
            Collection = MongoDatabase<T>.GetCollectionFromConnectionString(connectionString, collectionName);
        }
        ...
        {
            return Get(filter, i => i.Id, pageIndex, size);
        }
        ...
        {
            return Get(filter, order, pageIndex, size, true);
        }
        ...
        /// <returns>collection of entity</returns>
        public virtual IEnumerable<T> Get(Expression<Func<T, bool>> filter, Expression<Func<T, object>> order, int pageIndex, int size, bool isDescending)
        {
            return Retry(() =>
            {
        ...
        {
            return GetAll(i => i.Id, pageIndex, size);
        }
        ...
        {
            return GetAll(order, pageIndex, size, true);
        }
        ...
        /// <param name="isDescending">ordering direction</param>
        /// <returns>collection of entity</returns>
        public virtual IEnumerable<T> GetAll(Expression<Func<T, object>> order, int pageIndex, int size, bool isDescending)
        {
            return Retry(() =>
            {
        ...
        public T First()
        {
            return GetAll(i => i.Id, 0, 1, false).FirstOrDefault();
        }
        ...
        {
            return Get(filter, order, 0, 1, isDescending).FirstOrDefault();
        }
        ...
        public T Last()
        {
            return GetAll(i => i.Id, 0, 1, true).FirstOrDefault();
        }
